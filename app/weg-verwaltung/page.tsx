...
export const metadata: Metadata = {
  ...
  description:
    "Professionelle WEG-Verwaltung in München und Umgebung. Persönliche Betreuung, strukturierte Kommunikation, digitale Organisation. Mehr als 10 Jahre Erfahrung.",
  keywords:
    "WEG-Verwaltung München, Wohnungseigentumsverwaltung, Hausverwaltung WEG, Eigentümergemeinschaft München",
};
